              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(item.name, style: AppTextStyles.headline2),
                      ),
                      Column(
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('$_quantity', style: AppTextStyles.headline4),
                    ),
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      l10n.foodAddToCart + ' · ${_formatPrice(_totalPrice)}',
                    ),
                  ),
                ),
              ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(group.name, style: AppTextStyles.headline4),
              if (group.required)
                Padding(
