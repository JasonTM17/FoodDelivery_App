  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col bg-sidebar">
      <div className="flex h-16 items-center gap-2 border-b border-white/10 px-6">
        ...
        <span className="ml-1 rounded-full bg-blue-500/20 px-2 py-0.5 text-[10px] font-medium text-blue-400">
          Admin
        </span>
      </div>
      ...
      <div className="border-t border-white/10 p-4">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-sidebar-foreground transition-colors hover:bg-red-500/10 hover:text-red-400"
        >
