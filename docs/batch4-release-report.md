...
## Production recovery snapshot — 2026-07-17

Railway revision `84eeac3a2845868fc3a7fd45f8a73775e834a09d` recovered after the Supabase database password rotation. Railway migrator/API/worker recovery deployments `e61a23bc-ce7e-4ef7-9daa-12160e20f105`, `5b545476-8e0b-4208-8532-9d696bd5e00f`, and `e3b8a1cf-6432-4e6b-ac09-6e142e338da4` succeeded. The migrator found 42 migrations with none pending; the checksum audit reported `42/42`; health/readiness returned HTTP 200 with Database, Redis, and Supabase Storage up; worker polling resumed without authentication errors. This did **not** certify a unified release: Admin reported `e6def517…` while Restaurant reported `977d55f…`. The merged release helper now refuses any web rollout unless Railway API health reports the same full SHA first.

Docker Publish run `29590247679` built, runtime-smoked, scanned, and published the four immutable `sha-5ea63a1f645acf46af59c189a9535995f73a7a54` manifests to Docker Hub and public GHCR. This was a verified intermediate candidate, not a semver promotion. API and worker share `foodflow-backend`; there is deliberately no duplicate worker package. The final release must be rebuilt from the eventual tag commit and pass the same provider gates.
