...
Evidence health runtime hiện tại gắn với SHA `977d55f19ddc4fecafb8a758d2df034f4b6ff21d`. Railway API/worker/migrator và cả hai app Vercel báo revision này; database, Redis và Supabase Storage đều up. Evidence đầy đủ về release, registry, SBOM, đa kiến trúc và provider smoke vẫn gắn với tagged release SHA `a703ece61e66dcfe7f308cbf46a98098983233e7`, không phải chứng nhận cho `977d55f`. Các số liệu branch hiện tại và kết quả role/browser lịch sử bên dưới chỉ là evidence có phạm vi, không phải phê duyệt production end-to-end đầy đủ.
