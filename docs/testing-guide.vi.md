...
| Database       | Production có đủ 42 migration source active tại SHA `84eeac3`; readiness Database, Redis và Supabase Storage đều pass. Provenance Realtime, Job và Storage chính xác đã được khôi phục; audit chỉ-đọc pass 42/42. |
