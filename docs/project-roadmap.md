...
- Docker Hub and public GHCR SHA, `v0.1.2`, and `latest` aliases match for all four runtime images; Docker Publish run `29474270122` and Release run `29477368072` verified the promoted manifests. GHCR semver/latest promotion is not claimed because manifest writes returned `401 Unauthorized`.
