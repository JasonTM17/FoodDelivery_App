...
FoodFlow uses an LLM-first chatbot path in Batch 4. The backend AI module owns the runtime; external automation runners and public AI-tool routes are not used.
