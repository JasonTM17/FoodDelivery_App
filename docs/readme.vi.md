...
> **Trạng thái 17/07/2026:** Railway API/worker/migrator đang chạy runtime SHA `84eeac3a2845868fc3a7fd45f8a73775e834a09d`; credential Supabase đã xoay vòng và cả sáu biến URL database đã deploy. API health/readiness, Database, Redis, Supabase Storage và audit migration 42/42 đều xanh. Admin và Restaurant Vercel cùng báo chính xác source SHA `e6def517334681f3e003685489bd190e72408344`; quota cũ đã được giải quyết. Supabase có đúng hai bucket public/private, Broadcast private kiểm tra claim channel, Advisor không có lỗi. Docker Hub/GHCR có đủ bốn image SHA công khai; worker dùng chung image backend. Thiết bị vật lý Android/iOS, FCM kiểm soát, active-order, provider tùy chọn và full journey bốn role vẫn nằm ngoài chứng nhận.
