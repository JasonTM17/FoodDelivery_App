...
2. Khôi phục/review provenance checksum Storage còn lại, yêu cầu audit checksum pass, rồi backup và mới deploy migration 42 qua môi trường production đã duyệt. Không suy luận provenance từ schema end-state/Docker local hoặc dùng `prisma migrate resolve` để che blocker.
