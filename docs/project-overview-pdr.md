...
- API authorization applies identity, role, and tenant/ownership checks at the protected operation. Realtime channel claims are short-lived and private; token signing rechecks and share-locks the active user row so cleanup cannot overtake issuance.
