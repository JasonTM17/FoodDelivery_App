...
ADMIN_REQUIRED_ENV="NEXT_PUBLIC_API_URL NEXT_PUBLIC_WS_URL NEXT_PUBLIC_ADMIN_URL NEXT_PUBLIC_GOOGLE_MAPS_KEY"
RESTAURANT_REQUIRED_ENV="NEXT_PUBLIC_API_URL NEXT_PUBLIC_WS_URL NEXT_PUBLIC_RESTAURANT_URL NEXT_PUBLIC_GOOGLE_MAPS_KEY"
